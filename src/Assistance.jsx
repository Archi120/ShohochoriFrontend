...
const AssistancePage = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.get(`${API_BASE_URL}/assistant/all/`);
    ...
    const fetchPendingRequests = async () => {
        try {
            ...
            const response = await axios.get(
                `${API_BASE_URL}/pending/requests/user/${user_id}/`
            );
    ...
    const handleRequestAssistant = async (assistant) => {
        try {
            ...
            await axios.post(`${API_BASE_URL}/pending/send/`, requestData);
