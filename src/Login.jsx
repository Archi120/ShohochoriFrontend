  ...
  const handleLogin = async (event) => {
    ...
    try {
      if(activeRole === 'user') {
        ...
        const response = await axios.post(`${API_BASE_URL}/assistant/login/`, { "email": email, "password": password });
        ...
        const response = await axios.post(`${API_BASE_URL}/doctor/login/`, { "email": email, "password": password });
