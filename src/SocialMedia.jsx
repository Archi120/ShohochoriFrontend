...
const SocialMediaPage = () => {
    ...
    const fetchPosts = async () => {
        try {
            ...
            const response = await axios.get(`${API_BASE_URL}/user/feed/all/${userId}/`);
    ...
    const handlePostSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post(`${API_BASE_URL}/user/feed/post/`, formData, {
                headers: {
    ...
    const handleLike = async (postId) => {
        try {
            await axios.post(`${API_BASE_URL}/user/feed/like/`, {
    ...
    const handleComment = async (postId) => {
        ...
        try {
            await axios.post(`${API_BASE_URL}/user/feed/comment/`, {
                "user_id": localStorage.getItem('user_id'),
                "post_id": postId,
